...
was done, so neither moved to `ADMIN_WRITE_OPERATIONS.md` as a completed
operation — the sixteen expiries keep their registered entry at §59, waiting,
and the eight negative wallets have no entry because nothing has been
authorised to write.
