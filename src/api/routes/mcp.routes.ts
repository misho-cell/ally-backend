...
// claude.ai custom connector endpoint (MCP Streamable HTTP), Stage 1: Bearer =
// the app's own user JWT. Stateless — a fresh server+transport per request, no
// session ids; GET (SSE resume) and DELETE (session close) don't apply.
